...
import static com.android.internal.net.test.ipsec.ike.message.IkeMessage.DECODE_STATUS_OK;
import static com.android.internal.net.test.ipsec.ike.message.IkeMessage.DECODE_STATUS_PROTECTED_ERROR;
import static com.android.internal.net.test.ipsec.ike.message.IkeMessage.DECODE_STATUS_UNPROTECTED_ERROR;
import static com.android.internal.net.test.ipsec.ike.message.IkePayload.PAYLOAD_TYPE_AUTH;
import static com.android.internal.net.test.ipsec.ike.message.IkePayload.PAYLOAD_TYPE_ID_INITIATOR;
import static com.android.internal.net.test.ipsec.ike.message.IkePayload.PAYLOAD_TYPE_NO_NEXT;
import static com.android.internal.net.test.ipsec.ike.message.IkeTestUtils.makeDummySkfPayload;
...
import com.android.internal.net.test.ipsec.ike.crypto.IkeNormalModeCipher;
import com.android.internal.net.test.ipsec.ike.exceptions.InvalidMessageIdException;
...
import com.android.internal.net.test.ipsec.ike.message.IkeMessage.DecodeResultError;
...
import com.android.internal.net.test.ipsec.ike.message.IkePayloadFactory.IIkePayloadDecoder;
