...
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.EAP_SIM_RESPONSE_WITHOUT_IDENTITY;
...
import static com.android.internal.net.test.eap.message.simaka.EapSimAkaAttribute.EAP_AT_ENCR_DATA;
import static com.android.internal.net.test.eap.message.simaka.EapSimAkaAttribute.EAP_AT_IV;
import static com.android.internal.net.test.eap.message.simaka.EapSimAkaAttribute.EAP_AT_MAC;
import static com.android.internal.net.test.eap.message.simaka.EapSimAkaAttribute.EAP_AT_PERMANENT_ID_REQ;
import static com.android.internal.net.test.eap.message.simaka.EapSimAkaAttribute.EAP_AT_VERSION_LIST;
