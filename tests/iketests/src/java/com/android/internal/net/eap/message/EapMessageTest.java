...
package com.android.internal.net.test.eap.message;

import static com.android.internal.net.test.TestUtils.hexStringToByteArray;
import static com.android.internal.net.test.eap.message.EapData.EAP_NAK;
...
import static com.android.internal.net.test.eap.message.EapMessage.EAP_CODE_RESPONSE;
...
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.EAP_REQUEST_SIM_TYPE_DATA;
...
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.INCOMPLETE_HEADER_PACKET;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.INVALID_CODE_PACKET;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.LONG_SUCCESS_PACKET;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.REQUEST_MISSING_TYPE_PACKET;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.REQUEST_UNSUPPORTED_TYPE_PACKET;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.SHORT_PACKET;
...
import com.android.internal.net.test.eap.exceptions.EapInvalidPacketLengthException;
import com.android.internal.net.test.eap.exceptions.InvalidEapCodeException;
import com.android.internal.net.test.eap.exceptions.UnsupportedEapTypeException;
