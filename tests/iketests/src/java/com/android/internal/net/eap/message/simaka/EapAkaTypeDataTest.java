...
package com.android.internal.net.test.eap.message.simaka;

import static com.android.internal.net.test.TestUtils.hexStringToByteArray;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.EAP_AKA_CHALLENGE_RESPONSE_MAC_BYTES;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.EAP_AKA_CHALLENGE_RESPONSE_TYPE_DATA;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.EAP_AKA_IDENTITY_REQUEST;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.INVALID_SUBTYPE;
...
import static com.android.internal.net.test.eap.message.simaka.EapSimAkaAttribute.EAP_AT_ANY_ID_REQ;
import static com.android.internal.net.test.eap.message.simaka.EapSimAkaAttribute.EAP_AT_AUTN;
import static com.android.internal.net.test.eap.message.simaka.EapSimAkaAttribute.EAP_AT_CHECKCODE;
...
import static com.android.internal.net.test.eap.message.simaka.EapSimAkaAttribute.EAP_AT_RES;
...
import com.android.internal.net.test.eap.message.simaka.EapAkaTypeData.EapAkaTypeDataDecoder;
...
import com.android.internal.net.test.eap.message.simaka.EapSimAkaAttribute.AtRes;
import com.android.internal.net.test.eap.message.simaka.EapSimAkaAttribute.EapSimAkaUnsupportedAttribute;
