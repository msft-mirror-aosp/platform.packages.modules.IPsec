...
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.CHALLENGE_RESPONSE_INVALID_KC;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.CHALLENGE_RESPONSE_INVALID_SRES;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.EAP_SIM_IDENTITY_BYTES;
...
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.KC_1_BYTES;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.KC_2_BYTES;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.MSK;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.SRES_1_BYTES;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.SRES_2_BYTES;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.VALID_CHALLENGE_RESPONSE;
import static com.android.internal.net.test.eap.message.simaka.EapSimAkaAttribute.EAP_AT_MAC;
import static com.android.internal.net.test.eap.message.simaka.EapSimAkaAttribute.EAP_AT_RAND;
...
import static com.android.internal.net.test.eap.message.simaka.attributes.EapTestAttributeDefinitions.RAND_1;
import static com.android.internal.net.test.eap.message.simaka.attributes.EapTestAttributeDefinitions.RAND_1_BYTES;
import static com.android.internal.net.test.eap.message.simaka.attributes.EapTestAttributeDefinitions.RAND_2;
...
import com.android.internal.net.test.eap.exceptions.simaka.EapSimAkaInvalidAttributeException;
import com.android.internal.net.test.eap.exceptions.simaka.EapSimAkaInvalidLengthException;
...
import com.android.internal.net.test.eap.message.simaka.EapSimAkaAttribute.AtNonceMt;
...
import com.android.internal.net.test.eap.statemachine.EapSimMethodStateMachine.ChallengeState;
import com.android.internal.net.test.eap.statemachine.EapSimMethodStateMachine.ChallengeState.RandChallengeResult;
