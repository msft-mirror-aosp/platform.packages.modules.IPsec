...
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.COMPUTED_MAC;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.EAP_SIM_CHALLENGE_RESPONSE_MAC_INPUT;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.EAP_SIM_CHALLENGE_RESPONSE_WITH_MAC;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.EAP_SIM_CLIENT_ERROR_RESPONSE;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.EAP_SIM_CLIENT_ERROR_UNABLE_TO_PROCESS;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.EAP_SIM_IDENTITY;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.EAP_SIM_NOTIFICATION_REQUEST_WITH_EMPTY_MAC;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.EAP_SIM_NOTIFICATION_RESPONSE;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.EAP_SIM_NOTIFICATION_RESPONSE_WITH_EMPTY_MAC;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.EAP_SIM_NOTIFICATION_RESPONSE_WITH_MAC;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.EAP_SIM_RESPONSE_PACKET;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.EMSK;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.EMSK_STRING;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.ID_INT;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.KC_1;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.KC_2;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.K_AUT;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.K_AUT_STRING;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.K_ENCR;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.K_ENCR_STRING;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.MAC_INPUT;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.MK;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.MSK;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.MSK_STRING;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.ORIGINAL_MAC;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.SRES_1;
import static com.android.internal.net.test.eap.message.EapTestMessageDefinitions.SRES_BYTES;
import static com.android.internal.net.test.eap.message.simaka.EapSimAkaAttribute.AtNotification.GENERAL_FAILURE_POST_CHALLENGE;
import static com.android.internal.net.test.eap.message.simaka.EapSimAkaAttribute.AtNotification.GENERAL_FAILURE_PRE_CHALLENGE;
import static com.android.internal.net.test.eap.message.simaka.EapSimAkaAttribute.EAP_AT_MAC;
import static com.android.internal.net.test.eap.message.simaka.EapSimTypeData.EAP_SIM_CHALLENGE;
import static com.android.internal.net.test.eap.message.simaka.EapSimTypeData.EAP_SIM_CLIENT_ERROR;
import static com.android.internal.net.test.eap.message.simaka.EapSimTypeData.EAP_SIM_NOTIFICATION;
import static com.android.internal.net.test.eap.message.simaka.EapSimTypeData.EAP_SIM_START;
import static com.android.internal.net.test.eap.message.simaka.attributes.EapTestAttributeDefinitions.AT_IDENTITY;
import static com.android.internal.net.test.eap.message.simaka.attributes.EapTestAttributeDefinitions.IDENTITY;
import static com.android.internal.net.test.eap.message.simaka.attributes.EapTestAttributeDefinitions.NONCE_MT;
import static com.android.internal.net.test.eap.message.simaka.attributes.EapTestAttributeDefinitions.NONCE_MT_STRING;
import static com.android.internal.net.test.eap.message.simaka.attributes.EapTestAttributeDefinitions.RAND_1_BYTES;
import static com.android.internal.net.test.eap.message.simaka.attributes.EapTestAttributeDefinitions.RAND_2_BYTES;
import static com.android.internal.net.test.eap.statemachine.EapSimAkaMethodStateMachine.KEY_LEN;
import static com.android.internal.net.test.eap.statemachine.EapSimAkaMethodStateMachine.MAC_ALGORITHM_STRING;
import static com.android.internal.net.test.eap.statemachine.EapSimAkaMethodStateMachine.MASTER_KEY_GENERATION_ALG;
import static com.android.internal.net.test.eap.statemachine.EapSimAkaMethodStateMachine.SESSION_KEY_LENGTH;
...
import com.android.internal.net.test.eap.crypto.Fips186_2Prf;
import com.android.internal.net.test.eap.exceptions.EapInvalidRequestException;
import com.android.internal.net.test.eap.exceptions.simaka.EapSimAkaAuthenticationFailureException;
...
import com.android.internal.net.test.eap.message.simaka.EapSimAkaAttribute.AtClientErrorCode;
import com.android.internal.net.test.eap.message.simaka.EapSimAkaAttribute.AtIdentity;
import com.android.internal.net.test.eap.message.simaka.EapSimAkaAttribute.AtMac;
import com.android.internal.net.test.eap.message.simaka.EapSimAkaAttribute.AtNotification;
import com.android.internal.net.test.eap.message.simaka.EapSimAkaAttribute.AtRandSim;
import com.android.internal.net.test.eap.message.simaka.EapSimAkaAttribute.AtSelectedVersion;
import com.android.internal.net.test.eap.message.simaka.EapSimAkaTypeData;
import com.android.internal.net.test.eap.message.simaka.EapSimTypeData;
import com.android.internal.net.test.eap.statemachine.EapMethodStateMachine.EapMethodState;
