 ...
 *       This file should be used only within IPsec(IKE) mainline module.
...
public final class CloseGuard {
    ...
    public void warnIfOpen() {
        if (closerNameOrAllocationInfo != null) {
            if (closerNameOrAllocationInfo instanceof String) {
                android.util.Log.w("CloseGuard", "A resource failed to call "
    ...
    private static final class DefaultReporter implements Reporter {
        ...
        @Override public void report (String message, Throwable allocationSite) {
            android.util.Log.w("CloseGuard", message, allocationSite);
        }
    }
}
