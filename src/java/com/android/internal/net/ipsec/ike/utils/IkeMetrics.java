...
public class IkeMetrics {
     ...
     * closure.
     */
    // TODO: b/281577483 Define and add @IntDef annotations for the input parameters.
    public void logSessionTerminated(int ikeCaller, int sessionType, int ikeState, int ikeError) {
